...
window.decorateSeasonMedals = function () {
  document.querySelectorAll('.season-medal:not([data-medal-ready])').forEach(medal => {
    ...
    medal.innerHTML = '<img class="season-medal-art" src="./season-medal-2026-27.svg" alt="" aria-hidden="true"><span class="season-medal-caption">2026–2027 season medal</span><span class="season-medal-info" hidden>for participating in the season of 2026 - 2027</span>';
    const toggle = event => {
